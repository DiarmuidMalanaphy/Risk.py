...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="A script with a -g boolean flag.")
    
 # Define the -g flag as a boolean, using 'store_true'
    parser.add_argument('-g', action='store_true', help="Enable the -g flag. If present, it's True; otherwise, it's False.")
